    ...
    for (var i = 0; i < arrData.length; i++) {
        ...
        for (var colIndex = 0 ; colIndex < selectCol.length; colIndex++ ) {
          ...
          if (arrData[i][selectCol[colIndex]] == null) {
            ...
            var outputStr = value;
            if ( outputStr && typeof value === 'string' ) {
              outputStr = arrData[i][selectCol[colIndex]].replace(/(?:\r\n|\r|\n)/g, ' ');
              //half-width , => full-width ，
              outputStr = arrData[i][selectCol[colIndex]].replace(',', '，');
            }
            if (selectCol[colIndex] == "union_group") {
...
Meteor.myConstants = {
  ...
  currency: [
    ...
    {label: "美元", value: "USD", ratio: 6},
    {label: "欧元", value: "EUR", ratio: 8},
    {label: "英镑", value: "GBP", ratio: 10},
    {label: "港币", value: "HKD", ratio: 0.8},
    {label: "日元", value: "JPY", ratio: 0.05},
    {label: "澳大利亚元", value: "AUD", ratio: 5},
    {label: "新西兰元", value: "NZD", ratio: 5},
    {label: "加拿大元", value: "CAD", ratio: 5},
    {label: "新加坡元", value: "SGD", ratio: 5},
    {label: "以色列谢克尔", value: "ILS", ratio: 1},
    {label: "朝鲜元", value: "KPW", ratio: 0.005},
    {label: "韩国元", value: "KRW", ratio: 0.005},
    {label: "澳门元", value: "MOP", ratio: 0.8},
    {label: "新台币", value: "TWD", ratio: 0.2},
    {label: "印度卢比", value: "INR", ratio: 2},
    {label: "瑞士法郎", value: "CHF", ratio: 2},
    {label: "丹麦克朗", value: "DKK", ratio: 2},
    {label: "挪威克朗", value: "NOK", ratio: 2},
    {label: "瑞典克朗", value: "SEK", ratio: 2},
    {label: "泰铢", value: "THB", ratio: 2},
    {label: "阿联酋迪拉姆", value: "AED", ratio: 2},
    {label: "印度尼西亚卢比", value: "IDR", ratio: 0.5},
    {label: "马来西亚林吉特", value: "MYR", ratio: 0.5},
    {label: "菲律宾比索", value: "PHP", ratio: 0.5},
    {label: "俄罗斯卢布", value: "RUB", ratio: 0.5},
    {label: "巴西雷亚尔", value: "BRL", ratio: 0.5},
    {label: "南非兰特", value: "ZAR", ratio: 0.5},
  ...
  group_info: [
    ...
    {label: "海矿", value: "海矿", "budget" : 100000},
    {label: "互联网集团", value: "互联网集团", "budget" : 100000},
    {label: "互联网投资部", value: "互联网投资部", "budget" : 100000},
